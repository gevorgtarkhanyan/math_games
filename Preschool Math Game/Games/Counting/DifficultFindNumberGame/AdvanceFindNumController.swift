//
//  AdvanceFindNumController.swift
//  Preschool Math Game
//
...
class AdvanceFindNumController: BaseViewController {
    ...
    @IBOutlet weak var eleventhImage: UIImageView!
    @IBOutlet weak var twelvethImage: UIImageView!
    ...
    @IBOutlet var thirdNumbersGroup: [UIImageView]!
    ...
    static func initWithStoryboard() -> AdvanceFindNumController? {
        let storyboard = UIStoryboard(name: "CountingGames", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: AdvanceFindNumController.name) as? AdvanceFindNumController
    }
    ...
    private func configureImageView() {
        ...
        let secondNumber: Int = Random.getRandomIndex(in: 0..<(maxNumber - 2), ignoredIndexes: [firstNumber])
        let thirdNumber: Int = Random.getRandomIndex(in: 0..<(maxNumber - 2), ignoredIndexes: [firstNumber, secondNumber])
        ...
        for i in thirdNumber..<(thirdNumber + count) {
            thirdLimit_4Array.append(numbers[i])
        }
        ...
        ninthImage.image = UIImage(named: "btn_\(thirdLimit_4Array[0])")
        ninthImage.tag = thirdLimit_4Array[0]
        tenthImage.image = UIImage(named: "btn_\(thirdLimit_4Array[1])")
        tenthImage.tag = thirdLimit_4Array[1]
        eleventhImage.image = UIImage(named: "btn_\(thirdLimit_4Array[2])")
        eleventhImage.tag = thirdLimit_4Array[2]
        twelvethImage.image = UIImage(named: "btn_\(thirdLimit_4Array[3])")
        twelvethImage.tag = thirdLimit_4Array[3]
        
        allArray = [firstNumbersGroup, secondNumbersGroup, thirdNumbersGroup]
    ...
    private func setupButtonsImage() {
        ...
        rightAnswers.append(finalCounts[2])
...
extension AdvanceFindNumController:handlePanGestureDelegate {
