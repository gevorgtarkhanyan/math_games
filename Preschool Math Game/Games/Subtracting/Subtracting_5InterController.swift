//
//  Subtracting_5InterController.swift
//  Preschool Math Game
//
...
class Subtracting_5InterController: BaseViewController {
    ...
    static func initWithStoryboard() -> Subtracting_5InterController? {
        let storyboard = UIStoryboard(name: "SubtractingGames", bundle: nil)
        return storyboard.instantiateViewController(withIdentifier: Subtracting_5InterController.name) as? Subtracting_5InterController
    }
...
extension Subtracting_5InterController:handlePanGestureDelegate {
